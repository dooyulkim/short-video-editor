...
describe("useKeyboardShortcuts", () => {
	...
	it("should not trigger shortcuts when focus is within a dialog", async () => {
		renderHook(() => useKeyboardShortcuts(), { wrapper });

		// Create a dialog with an input inside
		...
		// Simulate Delete/Backspace key press from within the dialog
		const deleteEvent = new KeyboardEvent("keydown", {
			key: "Backspace",
			bubbles: true,
		});
		Object.defineProperty(deleteEvent, "target", { value: dialogInput, enumerable: true });

		dialogInput.dispatchEvent(deleteEvent);
