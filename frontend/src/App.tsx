...
import { ChevronLeft, ChevronRight, PanelLeftClose, PanelRightClose, Music } from "lucide-react";
						...
						<div className="flex-1 flex overflow-hidden">
							...
							<div className="flex-1 flex flex-col overflow-hidden bg-gradient-to-b from-zinc-950 to-zinc-900 border-r border-border">
								...
								<div className="flex-1 flex items-center justify-center p-4 overflow-hidden">
									<div className="w-full h-full max-w-5xl bg-black rounded-lg overflow-hidden shadow-2xl border border-border/50 flex items-center justify-center">
