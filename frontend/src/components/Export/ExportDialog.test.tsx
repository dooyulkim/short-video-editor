...
describe('ExportDialog Component', () => {
  ...
  describe('Dialog Close Behavior', () => {
    it('should call onOpenChange when footer close button is clicked', async () => {
      ...
      const footerCloseButton = footerButtons.find(btn => 
        btn.textContent?.includes('Close') && btn.className.includes('inline-flex')
      );
  ...
  describe('Export Settings', () => {
    it('should display default resolution', () => {
      ...
      const resolutionButton = screen.getByLabelText('Resolution');
