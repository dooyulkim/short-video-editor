	...
	describe("Zoom Functionality", () => {
		it("should zoom in when zoom in button is clicked", () => {
			...
			const zoomInButton = screen
				.getAllByRole("button")
				.find((btn) => btn.querySelector("svg")?.classList.contains("lucide-plus") || btn.textContent?.includes("+"));
		...
		it("should zoom out when zoom out button is clicked", () => {
			...
			const zoomOutButton = screen
				.getAllByRole("button")
				.find((btn) => btn.querySelector("svg")?.classList.contains("lucide-minus") || btn.textContent?.includes("-"));
		...
		it("should respect minimum zoom level", () => {
			...
			const zoomOutButton = screen
				.getAllByRole("button")
				.find((btn) => btn.querySelector("svg")?.classList.contains("lucide-minus"));
